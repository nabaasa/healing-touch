		...
		?>
        	<style type="text/css">
					...
					.blog-post-repeat .blog-title a{
						color:<?php echo  esc_attr(get_theme_mod('color_scheme','#ffffff')); ?>;
					}
					.slide_more a:hover{
						border-color:<?php echo esc_attr(get_theme_mod('color_scheme','#f39223')); ?>;
					}
					...
					.pagination ul li .current, .pagination ul li a:hover, .feature-box{
						background-color:<?php echo esc_attr(get_theme_mod('color_scheme','#030634')); ?>
					}
					.site-nav li:hover a, 
